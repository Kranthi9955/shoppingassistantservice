...
environment {
    IMAGE_NAME = "sunny5577/shoppingassistantservice:${GIT_COMMIT}"
}
...
stages {
    ...
    stage('Git Checkout') {
        steps {
            git url: 'https://github.com/Kranthi9955/shoppingassistantservice.git', branch: 'main'
        }
    }
    ...
    stage('Login to Docker Hub') {
        steps {
            withCredentials([usernamePassword(
                ...
                usernameVariable: 'sunny557',
                passwordVariable: 'Goacity$55'
            )]) {
